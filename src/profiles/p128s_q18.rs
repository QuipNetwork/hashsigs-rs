...
impl Profile for Profile128sQ18 {
    ...
    const PROFILE_ID: [u8; 32] = identity::p128s_q18::PROFILE_ID;
...
const _: () = assert!(
    crate::profile::str_eq(
        <Profile128sQ18 as Profile>::PROFILE_NAME,
        identity::p128s_q18::PROFILE_NAME
    ),
...
/// this alias's own `32, 1`, independently of `Profile128sQ18::NUM_WOTS_CHAINS`
...
const _: () = crate::profile::assert_widths::<Profile128sQ18, 32, 1>();
