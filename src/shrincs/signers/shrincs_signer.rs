...
//!
//! - `signers::uxmss` builds stateful WOTS-C signatures.
//! - `signers::fors_c` opens the fixed FORS forest for a message digest.
//! - `signers::hypertree` carries the FORS root to the hypertree root.

#[cfg(test)]
pub(crate) use super::super::verifier;
use super::super::types::{ActionContext, PublicKey, StatefulSignature, StatelessSignature};

pub use super::types::{ShrincsSignerResult, ShrincsSigningKey};

use super::fors_c::sign_fors_c;
use super::hypertree::{hypertree_public_root, sign_hypertree};
#[cfg(any(test, feature = "wasm-bindings"))]
use super::uxmss::sign_stateful_raw_at_leaf as sign_stateful_raw_at_leaf_inner;
use super::uxmss::{
